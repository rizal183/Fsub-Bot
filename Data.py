...
🚀Powerd By @groupmoviex
    ...
    buttons = [
        ...
        [InlineKeyboardButton("👨‍💻 Devoloper 👨‍💻", url="https://t.me/groupmoviex")],
...
Powerd By [groupmoviex Network](https://t.me/groupmoviex)
    """
...
A Telegram Force Subscribing Bot by @Riswan_x
